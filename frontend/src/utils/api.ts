...
export const createTransaction = async (transactionData: any) => {
  try {
    const response = await axios.post(`${LOANDISK_BASE_URL}/transactions`, transactionData);
    return response.data;
  } catch (error) {
...
export const updateTransaction = async (id: string, transactionData: any) => {
  try {
    const response = await axios.put(`${LOANDISK_BASE_URL}/transactions/${id}`, transactionData);
    return response.data;
  } catch (error) {
...
export const cancelTransaction = async (id: string) => {
  try {
    const response = await axios.post(`${LOANDISK_BASE_URL}/transactions/${id}/cancel`);
    return response.data;
  } catch (error) {
...
export const getTransactionStatistics = async () => {
  try {
    const response = await axios.get(`${LOANDISK_BASE_URL}/transactions/statistics`);
    return response.data;
  } catch (error) {
